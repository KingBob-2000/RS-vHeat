...
class vHeat(nn.Module):
    def __init__(self, patch_size=4, in_chans=3, num_classes=1000, depths=[2, 2, 9, 2],
        ...
        self.load_pretrained(ckpt="/mnt/AIService/FoundationModel/Mamba/Vheat/pretrained/remote_only_pretrained_200.pth")
        # self.load_pretrained(ckpt="/mnt/AIService/FoundationModel/Mamba/Vheat/pretrained/vHeat_base.pth")
    ...
    def load_pretrained(self, ckpt=None, key="model"):
        ...
        try:
            ...
            for k, v in _ckpt[key].items():
                if "classifier" in k:
                    continue
                k = k.replace("encoder.", "").replace("patch_embed_opt", "patch_embed")
