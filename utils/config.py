...
_C.DATA.DATA_PATH = ''
# Dataset name
# _C.DATA.DATASET = 'NWPU-RESISC45'
_C.DATA.DATASET = 'AID'
# _C.DATA.DATASET = 'test'
# Input image size
...
# VHEAT parameters
_C.MODEL.VHEAT = CN()
_C.MODEL.VHEAT.PATCH_SIZE = 4
_C.MODEL.VHEAT.IN_CHANS = 3
_C.MODEL.VHEAT.EMBED_DIM = 96
_C.MODEL.VHEAT.DEPTHS = [2, 2, 9, 2]
_C.MODEL.VHEAT.MLP_RATIO = 4.
_C.MODEL.VHEAT.PATCH_NORM = True
_C.MODEL.VHEAT.POST_NORM = False #True
_C.MODEL.VHEAT.LAYER_SCALE = None
